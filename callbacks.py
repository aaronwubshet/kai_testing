...
class AthleteProfileCallbacks:
    ...
    def register_callbacks(app):
        ...
        def update_athlete_profile(file_values, hierarchical_data, debug_mode):
            ...
            athlete_key = FileAnalyzer.get_athlete_from_filename(first_file)
...
class FileSelectionCallbacks:
    """Callbacks related to file selection management"""
    ...
    def register_callbacks(app):
        ...
        def update_file_selection_wrapper(debug_mode):
            ...
            if is_debug:
                ...
                return FileSelectionLayout.create_normal_mode()
        
        @app.callback(
            Output(COMPONENT_IDS['file_selection'], 'children'),
            Input(COMPONENT_IDS['debug_toggle'], 'value')
        )
        def update_file_selection(debug_mode):
            ...
            if is_debug:
                ...
                return FileSelectionLayout.create_checklist()
...
def register_all_callbacks(app):
    ...
    FileSelectionCallbacks.register_callbacks(app)
